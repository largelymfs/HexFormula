...
var contextPath = url.substring(0, url.lastIndexOf('/') + 1);
...
MathExpression.prototype = {
    ...
    sigma14: function (scale) {
        ...
        opObj.html("<img src='" + contextPath + "images/formula/qiuhe6b.png' />");
    ...
    sigma12: function (scale) {
        ...
        var rightObj = this.MathObj.find(">span:nth-child(3)"); //右
        var downObj = this.MathObj.find(">span:nth-child(4)"); //下
        opObj.html("<img src='" + contextPath + "images/formula/qiuhe7b.png' />");
        var opheight = opObj.height();
        var uptd = 0 - opheight / 2 - 14;
        var uprl = upObj.width() / 2;
        var rightrl = 0;
    ...
    sigma10: function (scale) {
        ...
        var rightObj = this.MathObj.find(">span:nth-child(3)"); //右
        var downObj = this.MathObj.find(">span:nth-child(4)"); //下
        opObj.html("<img src='" + contextPath + "images/formula/qiuhe4b.png' />");
        var opheight = opObj.height();
        var uptd = 0 - opheight / 2 - 14;
        var uprl = upObj.width() / 2;
        var rightrl = 0;
    ...
    sigma8: function (scale) {
        ...
        var rightObj = this.MathObj.find(">span:nth-child(3)"); //右
        var downObj = this.MathObj.find(">span:nth-child(4)"); //下
        opObj.html("<img src='" + contextPath + "images/formula/qiuhe5b.png' />");
        var opheight = opObj.height();
        var uptd = 0 - opheight / 2 - 14;
        var uprl = upObj.width() / 2;
        var rightrl = 0;
    ...
    sigma6: function (scale) {
        ...
        var rightObj = this.MathObj.find(">span:nth-child(3)"); //右
        var downObj = this.MathObj.find(">span:nth-child(4)"); //下
        opObj.html("<img src='" + contextPath + "images/formula/qiuhe3b.png' />");
        var opheight = opObj.height();
        var uptd = 0 - opheight / 2 - 14;
        var uprl = upObj.width() / 2;
        var rightrl = 0;
    ...
    sigma4: function (scale) {
        ...
        var rightObj = this.MathObj.find(">span:nth-child(3)"); //右
        var downObj = this.MathObj.find(">span:nth-child(4)"); //下
        opObj.html("<img src='" + contextPath + "images/formula/qiuhe2b.png' />");
        var opheight = opObj.height();
        var uptd = 0 - opheight / 2 - 14;
        var uprl = upObj.width() / 2;
        var rightrl = 0;
    ...
    sigma2: function (scale) {
        ...
        var rightObj = this.MathObj.find(">span:nth-child(3)"); //右
        var downObj = this.MathObj.find(">span:nth-child(4)"); //下
        opObj.html("<img src='" + contextPath + "images/formula/qiuhe1b.png' />");
        var opheight = opObj.height();
        var uptd = 0 - opheight / 2 - 14;
        var uprl = upObj.width() / 2;
        var rightrl = 0;
    ...
    integral88: function (scale) {
        ...
        var rightObj = this.MathObj.find(">span:nth-child(3)"); //右
        var downObj = this.MathObj.find(">span:nth-child(4)"); //下
        opObj.html("<img src='" + contextPath + "images/formula/jifenb.png' />");
    ...
    integral14: function (scale) {
        ...
        opObj.html("<img src='" + contextPath + "images/formula/jifen6b.png' />");
    ...
    integral12: function (scale) {
        ...
        var supObj = this.MathObj.find(">span:nth-child(3)"); //上标
        var subObj = this.MathObj.find(">span:nth-child(4)"); //下标
        opObj.html("<img src='" + contextPath + "images/formula/jifen5b.png' />");
        var suptd = supObj.height();
        var subtd = subObj.height() / 2;
        var subrl = 0;
        var rightrl = 0;
    ...
    integral10: function (scale) {
        ...
        var supObj = this.MathObj.find(">span:nth-child(3)"); //上标
        var subObj = this.MathObj.find(">span:nth-child(4)"); //下标
        opObj.html("<img src='" + contextPath + "images/formula/jifen4b.png' />");
        var suptd = supObj.height();
        var subtd = subObj.height() / 2;
        var subrl = 0;
        var rightrl = 0;
    ...
    integral8: function (scale) {
        ...
        var supObj = this.MathObj.find(">span:nth-child(3)"); //上标
        var subObj = this.MathObj.find(">span:nth-child(4)"); //下标
        opObj.html("<img src='" + contextPath + "images/formula/jifen7b.png' />");
        var suptd = supObj.height();
        var subtd = subObj.height() / 2;
        var subrl = 0;
        var rightrl = 0;
    ...
    integral6: function (scale) {
        ...
        var supObj = this.MathObj.find(">span:nth-child(3)"); //上标
        var subObj = this.MathObj.find(">span:nth-child(4)"); //下标
        opObj.html("<img src='" + contextPath + "images/formula/jifen3b.png' />");
        var suptd = supObj.height();
        var subtd = subObj.height() / 2;
        var subrl = 0;
        var rightrl = 0;
    ...
    integral4: function (scale) {
        ...
        var supObj = this.MathObj.find(">span:nth-child(3)"); //上标
        var subObj = this.MathObj.find(">span:nth-child(4)"); //下标
        opObj.html("<img src='" + contextPath + "images/formula/jifen2b.png' />");
        var suptd = supObj.height();
        var subtd = subObj.height() / 2;
        var subrl = 0;
        var rightrl = 0;
    ...
    integral2: function (scale) {
        ...
        var supObj = this.MathObj.find(">span:nth-child(3)"); //上标
        var subObj = this.MathObj.find(">span:nth-child(4)"); //下标
        opObj.html("<img src='" + contextPath + "images/formula/jifen1b.png' />");
    ...
    root: function (scale) {
        ...
        var fontsize = parseInt(this.MathObj.css("font-size"));
        if (bnumheight < 25) {
            opObj.html("<img src='" + contextPath + "images/formula/genhaob.png' />");
        }
        else if (bnumheight > 25 && bnumheight < 50) {
            opObj.html("<img src='" + contextPath + "images/formula/genhao1b.png' />");
        }
        else {
            opObj.html("<img src='" + contextPath + "images/formula/genhao2b.png' />");
        }
